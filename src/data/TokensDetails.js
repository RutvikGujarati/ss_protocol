...
export const TokensDetails = () => {
	...
	return [
		...
		{
			tokenName: "Valir",
			key: shortenedAddresses.ValirShortened,
			name: "Valir",
			...
			actions: {
				...
				SetDuration: (value) => SetAUctionDuration(value, "ValirRatio"),
				SetInterval: (value) => SetAUctionInterval(value, "ValirRatio"),
				AddTokenToContract: () =>
					AddTokensToContract(Valir, STATE_TOKEN_ADDRESS, CurrentRatioPrice.Valir),
				setRatio: (value) => setRatioTarget(value, "ValirRatio"),
				setBurn: (value) => setBurnRate(value, "ValirRatio"),
				setReverseEnabled: () => setReverseEnable("ValirRatio"),
				setReverse: (value, value2) => setReverseTime(value, value2),
				setCurrentRatio: (value) => setCurrentRatioTarget(value),
				DepositTokens: (value) =>
					DepositToken("Valir", Valir, value, "ValirRatio"),
				DepositStateTokens: (value) =>
					DepositToken("state", STATE_TOKEN_ADDRESS, value, "ValirRatio"),
				StartingAuction: () => StartAuction("ValirRatio"),
			},
		},
		{
			tokenName: "10$",
