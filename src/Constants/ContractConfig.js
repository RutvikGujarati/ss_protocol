import {
	...
	Rieva, RievaRatioAddress, Sanitas, SanitasRatioAddress, STATE_TOKEN_ADDRESS, STATE_TOKEN_SONIC_ADDRESS, Teech, TenDollarRatioAddress,
...
export const getContractConfigs = () => ({
	...
	TeechContract: { address: Teech, abi: StateABI },
