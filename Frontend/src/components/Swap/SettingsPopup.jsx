                    ...
                    <div className="modal-content bg-dark text-light" ref={popupRef}>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="d-flex gap-2 mb-3">
                                <button
                                    className={`btn btn-sm ${isAutoSlippage ? "btn-primary" : "btn-outline-primary"} rounded-pill flex-fill`}
                            ...
                            <div className="alert alert-info bg-secondary border-0 text-light small mb-0">
                                ...
                                <strong>Slippage tolerance</strong> is the maximum price movement you're willing to accept for your swap.
                            </div>
                        </div>
                    </div>
                </div>
